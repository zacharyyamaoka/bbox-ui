...
/**
 * Reset-to-stock: a counter-clockwise revert arrow.
 *
 * Not a Figma glyph — Figma has no concept of "stock", so there is nothing to
 * transcribe. The first attempt drew an arrow rising out of a box and read as
 * EXPORT, which is the opposite of what this does; a circular revert arrow is
 * the shape every tool uses for "put it back". Same 24px box and 1.5 stroke as
 * the rest, so it sits in the row without announcing itself as foreign.
 */
export const ResetToStock = (p: FigmaIconProps) => (
